...
// =====================================================================================
/* .split('separador') -> Divide una cadena en subcadenas buscando el separador especificado
    y lo devuelve como un array */

    /* console.log(cadena.split(' ')) // Devuelve un array de longitud 2, con los elementos */
    // "Hola", en la posición 0 y "Mundo" en la posición 1. Esto es porque hemos usado como separador
    // un espacio ' '.
    // Si no indicamos separador devuelve un array con cada uno de los caracteres
    /* console.log(cadena.split('')) // En este caso la longitud del array es de 10 */
